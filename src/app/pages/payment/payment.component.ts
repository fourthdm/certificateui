...
export class PaymentComponent implements OnInit {
  ...
  constructor(private payment: CashfreeService, private _router: Router, private toastr: ToastrService, private spinner: NgxSpinnerService,
    private http: HttpClient, private fb: FormBuilder, private zone: NgZone) {
  ...
  async ngOnInit() {
    ...
    console.log('Cashfree SDK loaded:', this.cashfree);
    // this.launchConfetti();
  }
